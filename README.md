...
1. Clone the workspace to your diseried directory on your local machine
   1. Remove the .git from the workspace and initilise your wont `git init`. 
2. Install all the dependencies as shown in the installation 

3. Add your code in the in the src directory, i.e `src/my_awsome_pkg`
...
- `.devcontainer`: Used for devcontainer[here](https://marketplace.visualstudio.com/items?itemName=ms-vscode-remote.remote-containers) configureations, contains a configuration file and  
